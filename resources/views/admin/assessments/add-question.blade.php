...
@section('title','Add Question to Assessment')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="mb-0">Add Question to {{ $assessment['name'] ?? 'Assessment' }}</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ url('/admin/assessments/' . ($assessment['id'] ?? '') . '/store-question') }}">
                @csrf
                <div class="mb-3">
