...
<div class="hero-section">
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('student.assessments.index') }}" class="btn btn-light">
                <i class="fa-solid fa-clipboard-list me-2"></i>View Assessments
            </a>
            <a href="{{ route('student.assessment.history') }}" class="btn btn-outline-light">
    ...
    <div class="col-12">
        <div class="card stat-card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('student.assessments.index') }}" class="btn btn-sm btn-outline-primary">View All</a>
            </div>
            <div class="card-body">
                <div class="row g-3">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2 mb-2">
                                            ...
                                            <span class="badge bg-info">{{ $assessment->total_time ?? 0 }} min</span>
                                        </div>
                                    </div>
                                    @if(isset($attemptsByAssessment[$assessment->id]))
                                        ...
                                        <a href="{{ route('student.assessments.result', $assessment) }}" class="btn btn-outline-success w-100 btn-sm">
                                            <i class="fas fa-eye me-1"></i>View Results & Review
                                        </a>
                                    @else
                                        <a href="{{ route('student.assessments.show', $assessment) }}" class="btn btn-primary w-100 btn-sm">Start Assessment</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <li class="list-group-item d-flex align-items-center justify-content-between">
                            ...
                            <div class="text-end">
                                ...
                                <div class="mt-1">
                                    ...
                                    @if($assessment)
                                        <a href="{{ route('student.assessments.result', $assessment) }}" class="btn btn-sm btn-outline-secondary">View</a>
                                        <a href="{{ route('student.assessments.show', $assessment) }}" class="btn btn-sm btn-outline-secondary">Retake</a>
                                    @else
                                        <span class="text-muted small">Assessment no longer available</span>
                                    @endif
                                </div>
                            </div>
                        </li>
